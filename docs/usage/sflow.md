...
The workload pair dashboard starts from a source workload and destination workload and shows src-to-dst traffic and dst-to-src traffic, grouped by the switches that observed each direction.
