...
Open the rendered `Unifabric Switch sFlow`, `Unifabric Workload sFlow`, and `Unifabric Workload src to dst sFlow` dashboards.
...
- The workload pair dashboard should show src-to-dst traffic and dst-to-src traffic by observing switch for the selected workload pair.
