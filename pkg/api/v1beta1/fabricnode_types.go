...
type FabricNodeStatus struct {
	RdmaHealthy bool      `json:"rdmaHealthy"`
	TotalNics   int       `json:"totalNics"`
	RdmaPods    []RdmaPod `json:"rdmaPods,omitempty"`
	GpuNics     []NicInfo `json:"gpuNics,omitempty"`
...
// +kubebuilder:printcolumn:name="RdmaHealthy",type=boolean,JSONPath=`.status.rdmaHealthy`
// +kubebuilder:resource:categories=fabricnode,path=fabricnodes,singular=fabricnode,scope=Cluster,shortName=fn
// +kubebuilder:subresource:status
// +kubebuilder:printcolumn:name="Type",type="string",JSONPath=".status.nodeType",description="Node type"
