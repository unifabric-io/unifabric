...
func NewClickHouseConn(ctx context.Context, cfg config.SFlowClickHouseConfig) (chdriver.Conn, error) {
	return newClickHouseConn(ctx, cfg, cfg.Database)
}

func NewClickHouseSchemaConn(ctx context.Context, cfg config.SFlowClickHouseConfig) (chdriver.Conn, error) {
	return newClickHouseConn(ctx, cfg, "default")
}

func newClickHouseConn(ctx context.Context, cfg config.SFlowClickHouseConfig, database string) (chdriver.Conn, error) {
