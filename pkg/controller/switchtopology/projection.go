...
func buildDesiredState(cfg *config.ControllerConfig, fabricNodes []v1beta1.FabricNode, switches []v1beta1.Switch) ([]desiredTopologyGroup, map[string]desiredNodeLabels, []string) {
