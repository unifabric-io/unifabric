...
func lldpCollectionOptions(cfg *config.SwitchAgentConfig) fabricnode.LldpCliOptions {
	...
	case "1.0.4":
		return fabricnode.LldpCliOptions{BinaryPath: lldpCLI104Path, SocketPath: cfg.LLDP.SocketPath, FallbackToPath: true}
	default:
		return fabricnode.LldpCliOptions{BinaryPath: lldpCLI116Path, SocketPath: cfg.LLDP.SocketPath, FallbackToPath: true}
	}
}
