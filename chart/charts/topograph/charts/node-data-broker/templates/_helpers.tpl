...
{{/*
Default node selector for the IB-only topograph integration.
*/}}
{{- define "node-data-broker.nodeSelector" -}}
{{- $defaultSelector := dict .Values.global.topologyLabels.accelerator "true" -}}
{{- toYaml (mergeOverwrite $defaultSelector (.Values.nodeSelector | default dict)) -}}
{{- end }}
