...
Examples:
  ...
  bash e2e/topology/setup.sh step3-install-monitoring-operators --simulation my-simulation
...
case "${stage}" in
  ...
  all)
    ...
    run_step install-monitoring-operators.sh --simulation "${SIMULATION_NAME}"
